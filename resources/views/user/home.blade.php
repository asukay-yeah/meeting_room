...
<body class="font-[outfit]">
    ...
    <div id="content" class="content-shifted transition-all duration-300 w-full ease-in-out p-5 lg:pt-6">
        <div id="content-area w-full flex-col flex">
            <div class="flex flex-col relative bg-white w-full md:h-80 h-52">
            ...
            <div class="flex w-full justify-between md:my-8 my-6 ">
                <p class="text-center md:text-[40px] text-2xl text-[#1b1b1b]">Status Ruang Rapat <span
