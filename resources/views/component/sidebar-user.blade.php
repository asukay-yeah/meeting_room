        ...
        <aside id="sidebar"
            ...
            <div class="relative px-3 py-4 overflow-y-auto flex-grow">
                <div id="menu-items-container" class="flex flex-col w-full font-medium">
                    ...
                    <div class="{{ Route::is('user.home') ? 'border-l-[3px] border-[#1d4ed8] bg-[#1d4ed8]/10 text-blue-800' : 'hover:border-l-[3px] border-[#1d4ed8] hover:bg-[#1d4ed8]/10 text-stone-600 hover:text-blue-800' }} duration-300 my-1 rounded-lg overflow-hidden menu-item-animation">
                        <span class="select-none flex items-center px-4 py-3 cursor-pointer">
                            ...
                            <a href="{{ url('user/home') }}"
                                class="flex items-center flex-grow text-[1.05rem] text-blue-800">Home</a>
                        </span>
                    </div>

                    <!-- Reserve Room with Submenu -->
                    <div class="hover:border-l-[3px] border-[#1d4ed8] hover:bg-[#1d4ed8]/10 text-stone-600 hover:text-blue-800 duration-300 my-1 rounded-lg overflow-hidden menu-item-animation">
                        ...
                        <div id="floor-options" class="pl-12 hidden">
                            <div class="py-2 transition-all duration-200 flex items-center">
                                ...
                                <a href="javascript:;" class="text-stone-600 hover:text-blue-800 block py-1 w-full">1A
                                    Floor Room</a>
                            </div>
                            <div class="py-2 transition-all duration-200 flex items-center">
                                <i data-feather="codepen" class="w-4 h-4 text-gray-500 mr-2"></i>
                                <a href="javascript:;" class="text-stone-600 hover:text-blue-800 block py-1 w-full">1B
                                    Floor Room</a>
                            </div>
                            <div class="py-2 transition-all duration-200 flex items-center">
                                <i data-feather="codepen" class="w-4 h-4 text-gray-500 mr-2"></i>
                                <a href="javascript:;" class="text-stone-600 hover:text-blue-800 block py-1 w-full">2rd
                                    Floor Room</a>
                            </div>
                            <div class="py-2 transition-all duration-200 flex items-center">
                                <i data-feather="codepen" class="w-4 h-4 text-gray-500 mr-2"></i>
                                <a href="javascript:;" class="text-stone-600 hover:text-blue-800 block py-1 w-full">3rd
                                    Floor Room</a>
                            </div>
                        </div>
                    </div>
